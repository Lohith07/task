...
public class ContractTests {
    ...
    //     ManagementState state = new ManagementState("Hello-World",alice.getParty(),bob.getParty());
    //     ledger(ledgerServices, l -> {
    //         l.transaction(tx -> {
    //             tx.input(ManagementContract.ID, state);
    //             tx.output(ManagementContract.ID, state);
    //             tx.command(alice.getPublicKey(), new ManagementContract.Commands.Send());
